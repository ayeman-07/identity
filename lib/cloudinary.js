...
// Lightweight configuration export for frontend (unsigned) uploads
export const getUploadConfig = () => ({
  cloudName: process.env.CLOUDINARY_CLOUD_NAME,
  unsignedPreset: process.env.CLOUDINARY_UNSIGNED_PRESET || null,
  uploadEndpoint: `https://api.cloudinary.com/v1_1/${process.env.CLOUDINARY_CLOUD_NAME}/auto/upload`
});
