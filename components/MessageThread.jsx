...
export default function MessageThread({ caseId, currentUser }) {
  ...
  if (loading) {
    return (
      <div className="glass-card p-6">
        <h3 className="text-lg font-medium text-gray-100 mb-4">Case Communication</h3>
  ...
  if (caseInfo && !caseInfo.lab) {
    return (
      <div className="glass-card p-6">
        <h3 className="text-lg font-medium text-gray-100 mb-4">Case Communication</h3>
        <div className="rounded-md p-4 border border-yellow-400/20 bg-yellow-500/10">
          <div className="flex">
  ...
  if (caseInfo && caseInfo.status === 'NEW') {
    return (
      <div className="glass-card p-6">
        <h3 className="text-lg font-medium text-gray-100 mb-4">Case Communication</h3>
        <div className="rounded-md p-4 border border-blue-400/20 bg-blue-500/10">
          <div className="flex">
            <div className="flex-shrink-0">
  ...
  return (
    <div className="glass-card">
      ...
      <div className="px-6 py-4 border-b border-white/10">
        <h3 className="text-lg font-medium text-gray-100">Case Communication</h3>
        {caseInfo && (
      ...
      <div className="px-6 py-4">
        <div className="h-96 overflow-y-auto space-y-4 mb-4 bg-white/5 rounded-lg p-4">
          {messages.length === 0 ? (
        ...
        <form onSubmit={sendMessage} className="flex space-x-3">
          <div className="flex-1">
            <textarea
              ...
              rows={2}
              maxLength={1000}
              className="block w-full border border-white/20 bg-white/5 text-gray-100 rounded-md px-3 py-2 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none"
              disabled={sending}
            />
          ...
          <div className="flex-shrink-0">
            <button
              ...
              className="btn-gradient px-4 py-2 rounded-md text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed h-fit"
            >
